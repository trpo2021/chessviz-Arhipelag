...
{
	if (turn[i] == 'a') return 1;
	if (turn[i] == 'b') return 2;
	if (turn[i] == 'c') return 3;
	if (turn[i] == 'd') return 4;
	if (turn[i] == 'e') return 5;
	if (turn[i] == 'f') return 6;
	if (turn[i] == 'g') return 7;
	if (turn[i] == 'h') return 8;
	return 0;	
}
